/* jdf-1.0.0/ base.js Date:2017-07-13 17:39:13 */
if (!
function (a, b) {
    function c(a) {
        return function (b) {
    ...
    function g(a) {
        var b = a.length - 1,
            c = a.charAt(b);
        return "#" === c ? a.substring(0, b) : ".js" === a.substring(b - 2)
        || a.indexOf("?") > 0 || ".css" === a.substring(b - 3) || "/" === c ? a : a + ".js"
    }
    function h(a) {
        var b = v.alias;
    ...
    function k(a) {
        ...
        if (b) for (var d = 0, e = b.length; e > d; d++) {
                var f = b[d];
                if (c = zFunction(f) ? f(a) || a : a.replace(f[0], f[1]), c !== a) break
            }
        return c
    }
    function l(a, b) {
    ...
    function o(a, b, c) {
        var isCss = S.test(a),
            e = document.createElement(isCss ? "link" : "script");
        if (c) {
                var f = zFunction(c) ? c(a) : c;
                f && (e.charset = f)
            }
        p(e, b, isCss, a),
        isCss ? (e.rel = "stylesheet", e.href = a) : (e.async = !0, e.src = a),
        T = e,
    ...
    if (!a.seajs) {
        ...
        t.prototype.exec = function () {
                ...
                var f = c.factory,
                    g = zFunction(f) ? f(a, c.exports = {}, c) : f;
...
function () {
    ...
    function e(a) {
        for (var b = [], c = a.__KEYS, d = 0, e = c.length; e > d; d++) {
            for (var g = c[d], h = g, i = a[g], j = i.__KEYS; 1 === j.length;) h += "/" + j[0],
            i = i[j[0]],
            j = i.__KEYS;
...

{
    ...
    ("localhost" == location.hostname || /isdebu g=.*\-1(\D|$)/.test(location.search)) && (seajsConfig.comboExcludes = /.*/),
...
if (
    ...
    pageConfig.wideVersion && (document.getElementsByTagName("html")[0].className = "root61"),
...
pageConfig.FN_GetRandomData = function (a) {
    var d, b = 0,
        c = 0,
        e = [];
    for (var f = 0; f < a.length; f++) d = a[f].weight ? parseInt(a[f].weight) : 1,
    e[f] = [],
    e[f].push(b),
    b += d,
    e[f].push(b);
...
pageConfig.insertStyles = function (a) {
    ...
    if (/\.css$/.test(a)) e.rel = "stylesheet",
    e.type = "text/css",
    e.href = a,
